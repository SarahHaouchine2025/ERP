<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GESTION_AVOCATS_V2.aspx.cs" Inherits="URP_AADL.CONTENSIEUX.ADMIN.GESTION_AVOCATS_V2" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="tab-container">
            ...
            <!-- Onglets -->
            <div class="tabs">
                <div id="tab_1" class="tab active" onclick="openTab(1)">Liste Avocats</div>
                <div id="tab_2" class="tab" onclick="openTab(2)">Liste Avocat/Affaires</div>
            </div>
                ...
                <asp:ListView ID="LIST_OV" runat="server" DataKeyNames="ID_AVOCAT" OnItemDataBound="LIST_OV_ItemDataBound" OnItemEditing="LIST_OV_ItemEditing" OnItemUpdating="LIST_OV_ItemUpdating" OnItemCanceling="LIST_OV_ItemCanceling" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" AllowPaging="True" OnPagePropertiesChanging="LIST_OV_PagePropertiesChanging">
                    ...
                    <ItemTemplate>
                        <tr class="table-row" id="trAffaire" runat="server">
                            <td>
                                <asp:Label ID="NOM_AVOCAT" runat="server" Text='<%# Eval("NOM_AVOCAT") %> ' CssClass="table-data" /></td>
                            <td>
                                <asp:Label ID="PRENOM_AVOCAT" runat="server" Text='<%# Eval("PRENOM_AVOCAT") %>' CssClass="table-data" /></td>
                            <td>
                                <asp:Label ID="NOM_DR" runat="server" Text='<%# Eval("NOM_DR") %> ' CssClass="table-data" /></td>
                            ...
                            <td>
                                <asp:Label ID="USER_DDN" runat="server" Text='<%# Eval("DATE_DEBUT", "{0:d}") %>' CssClass="table-data" /></td>
                            <td>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("DATE_FIN", "{0:d}") %>' CssClass="table-data" /></td>
                            
                            <td runat="server" id="tdMntTribunal" visible="false">
                                <asp:Label ID="Label8" runat="server" Text='<%# Eval("MNT_AFF_TRIBUNAL") %>' CssClass="table-data" /></td>
                            <td runat="server" id="tdMntCours" visible="false">
                                <asp:Label ID="Label9" runat="server" Text='<%# Eval("MNT_AFF_COURS") %>' CssClass="table-data" /></td>
                            <td runat="server" id="tdMntCousSup" visible="false">
                                <asp:Label ID="Label10" runat="server" Text='<%# Eval("MNT_AFF_COURS_SUP") %>' CssClass="table-data" /></td>
                            <td runat="server" id="tdMntrefere" visible="false">
                                <asp:Label ID="Label11" runat="server" Text='<%# Eval("MNT_AFF_REFERE") %>' CssClass="table-data" /></td>
                            <td runat="server" id="td1" visible="false">
                                <asp:Label ID="Label13" runat="server" Text='<%# Eval("ID_AVOCAT") %>' CssClass="table-data" /></td>
                            <td runat="server" id="td2" visible="false">
                                <asp:Label ID="Label14" runat="server" Text='<%# Eval("NOM_DR") %>' CssClass="table-data" /></td>
                            <td runat="server" id="td3" visible="false">
                                <asp:Label ID="Label15" runat="server" Text='<%# Eval("NUM_CONVENTION") %>' CssClass="table-data" /></td>
                            <td class="action-cell">

                                <asp:LinkButton ID="btnList" runat="server" CssClass="action-btn doc-btn"
                                    CommandName="List" CommandArgument='<%# Eval("ID_AVOCAT") %>' ToolTip="Liste affaire" OnClick="btnListCnv_Click">  <%--OnClick="btnEdit_Click"--%>
...
%>'
        ...
        <!-- Contenu Onglet 2 -->
            ...
            <div class="search-panel">
                <div class="search-filter-panel">
                    <div class="search-header">
                        <h3><i class="fas fa-search"></i>Rechercher avocats</h3>
                        <button type="button" class="toggle-btn" onclick="toggleSearch_AVAFPanel()">
                            <i class="fas fa-chevron-down"></i>
                        </button>
                    </div>

                    <div class="search-grid" id="searchGrid_AFFAVO" style="display: none;">
                        ...
                        <div class="wide-form-row">
                            <div class="search-group">
                                <label for="TB_SEARCH_NOM">Nom et Prénom</label>
                                <asp:TextBox ID="TB_AVOCAT_AF" runat="server" CssClass="form-control"
                                    placeholder="Rechercher par nom"></asp:TextBox>
                            </div>
                            <div class="search-group">
                                <label for="DDL_DR_AF">DR</label>
                                <asp:DropDownList ID="DDL_DR_AF" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="">Tous</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="search-group">
                                <div class="dual-label-container">
                                    <label for="DDL_SEARCH_CNV">Date Affaire</label>
                                </div>
                                <div class="input-with-add">
                                    <asp:TextBox ID="TB_DATE_DEBUT_F" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
                                    <asp:TextBox ID="TB_DATE_FIN_F" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="search-group">
                                ...
                                <%--<div class="multi-dropdown">
                                    ...
                                    <asp:LinkButton ID="btnObsDropdown" runat="server"
                                        CssClass="multi-dropdown-btn form-control"
                                    ...
                                    <div class="multi-dropdown-menu">
                                        ...
                                        <asp:CheckBoxList ID="chkObservations" runat="server"
                                            CssClass="multi-dropdown-list checkbox-list"
                                            RepeatLayout="Flow"
                            ...
                            <div class="search-group">
                                <label>&nbsp;</label>
                                <asp:Button ID="BTN_SEARCHE_AVOCAT_AF" runat="server" Text="Rechercher"
                                    CssClass="btn btn-primary"  OnClick="BTN_SEARCHE_AVOCAT_AF_Click"  />
                            </div>
                        </div>
                ...
                <div class="data-section">
                    ...
                    <asp:ListView ID="LIST_AVOCAT_AFFAIRE" runat="server"
                        ItemPlaceholderID="itemPlaceHolder1"
                        DataKeyNames="ID_AVOCAT"
                        AllowPaging="True"
                        OnPagePropertiesChanging="LIST_AVOCAT_AFFAIRE_PagePropertiesChanging">
                        ...
                        <ItemTemplate>
                            <tr class="table-row" id="trAffaire" runat="server">
                                ...
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("NBR_AFFAIRE_COURS") %>' CssClass="table-data" /></td>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("NBR_AFFAIRE_COURS_SUP") %>' CssClass="table-data" /></td>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("NBR_AFFAIRE_REFERE") %>' CssClass="table-data" /></td>
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("MONTANT_GLOBAL") %>' CssClass="table-data" /></td>
                                <td>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("MONTANT_REST_A_PAYER") %>' CssClass="table-data" /></td>
                                <td>
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("MONTANT_PAYER") %>' CssClass="table-data" /></td>
                                ...
                                <td class="action-cell">
                                    ...
                                    <asp:LinkButton ID="btnList" runat="server" CssClass="action-btn doc-btn"
                                        CommandName="List" CommandArgument='<%# Eval("ID_AVOCAT") %>' ToolTip="Liste affaire" OnClick="btnList_Click">  
                                <i class="fas fa-list"></i>
                                    </asp:LinkButton>
                ...
                <div class="modal-footer">
                    <label>&nbsp;</label>
                    <asp:Button ID="Button2" runat="server" Text="Etat Avocats" OnClick="BTN_ETAT_AVOCAT_Click"
                        CssClass="btn-secondary" />
                    <%--<asp:Button ID="BTN_RESET_SEARCH" runat="server" Text="Réinitialiser" 
                        CssClass="btn-secondary" OnClick="BTN_RESET_SEARCH_Click" />--%>
                </div>
    ...
    <div id="ListCnvAvocatModal" class="modal">
        <div class="modal-content-affaire">
            <div class="modal-header">
                <h3><i class="fas fa-list"></i>Liste conventions de :
                    <asp:Label runat="server" ID="LB_AVOCAT_CNV" Text=""></asp:Label>
                </h3>
                <span class="close" onclick="closeListCnvAvocatModalModal()">&times;</span>
            </div>

            <div class="modal-body">
                <div class="data-section">
                    <asp:ListView ID="LIST_CNV_AVOCAT" runat="server"
                        DataKeyNames="ID_AVOCAT"
                        ItemPlaceholderID="itemPlaceHolder1"
                        AllowPaging="True"
                        OnPagePropertiesChanging="LIST_CNV_AVOCAT_PagePropertiesChanging">
                                ...
                                <table class="modern-data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Date début</th>
                                            <th>Date fin</th>
                                            <th runat="server" id="AVOCAT" visible="false">AVOCAT</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <asp:PlaceHolder runat="server" ID="itemPlaceHolder1" />
    ...
    <ItemTemplate>
        <tr>
            <td><%# Eval("NUM_CONVENTION") %></td>
            <td><%# Eval("DATE_DEBUT_CNV", "{0:dd/MM/yyyy}") %></td>
            <td><%# Eval("DATE_FIN_CNV", "{0:dd/MM/yyyy}") %></td>
            <td runat="server" id="tdAVOCAT" visible="false">
                                <asp:Label ID="Label11" runat="server" Text='<%# Eval("AVOCAT") %>' CssClass="table-data" /></td>
        </tr>
    </ItemTemplate>
    ...
    <EmptyDataTemplate>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-cancel" onclick="closeListCnvAvocatModalModal()">Annuler</button>
            ...
            <asp:ListView ID="LV_AFFAIRE_AVOCATS" runat="server" DataKeyNames="ID_AVOCAT" 
                ...
                <ItemTemplate>
                    <tr class="table-row">
                        ...
                        <td>
            <span class="status-badge <%# GetStatusClass_STRING(Eval("TYPE_PAIEMENT")) %>">
                <%# Eval("TYPE_PAIEMENT") %>
            </span>
        </td>
...
<script>
    ...
    function toggleSearch_AVAFPanel() {
        const grid = document.getElementById("searchGrid_AFFAVO");
    ...
    function openListCnvAvocatModal() {
        // Ouvrir le modal
        document.getElementById('ListCnvAvocatModal').style.display = 'block';
        return false;
    }
    ...
    function closeListCnvAvocatModalModal() {
        document.getElementById('ListCnvAvocatModal').style.display = 'none';
    }

...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wide-form-container bilingual-form">
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="wide-form-control"
                ...
                <div class="search-group">
                    ...
                    <asp:DropDownList ID="DDL_NATURE" runat="server"
                        ...
                        onchange="togglePrecisionNature()">
                        <asp:ListItem Text="------" Value="" Selected="True" />
                    </asp:DropDownList>
                </div>
        ...
        <div class="wide-form-section">
            ...
            <div class="wide-form-row">
                ...
                <div class="wide-form-group">
                    <div class="dual-label-container">
                        <span class="label-fr">Date d'envoi</span>
        ...
        <div class="wide-form-section">
            ...
            <div class="wide-form-row">
                ...
                <div class="search-group">
                    <div class="dual-label-container">
                        <span class="label-fr">Avocat</span>
            ...
            <div class="wide-form-row">
                <div class="wide-form-group full-width">
                    <div class="dual-label-container">
                        <span class="label-fr">Demandes de l'adversaire</span>
                        <span class="label-ar">طلبات المدعي</span>
                    </div>
        ...
        <div class="wide-form-section">
            <h5 class="wide-section-title">
                <span class="title-fr"><asp:Label runat="server" ID="titreSectionJugement" Text="Jugement"></asp:Label></span>
                <span class="title-ar"><asp:Label runat="server" ID="titreSectionJugementArabe" Text="الحكم"></asp:Label></span>
            </h5>
            <div class="wide-form-row">
                <%--<div class="wide-form-group">
                    <div class="dual-label-container">
            ...
            <div class="impact-financier-group">
                <div class="wide-form-row">
                    ...
                    <div class="search-group">
                        <div class="dual-label-container">
                            <span class="label-fr">Montant jugé</span>
                            <span class="label-ar">المبلغ المحكوم به</span>
                        </div>
                        <div class="input-with-add">
        ...
        <!-- Section Courier -->
        <div class="wide-form-section" runat="server" id="ScanCourier">
            <h5 class="wide-section-title">
        ...
        <div class="wide-form-section" runat="server" id="ScanAutre">
            <h5 class="wide-section-title">
                ...
                <span class="title-ar">وثائق أخرة</span>
            </h5>
    ...
    <div class="wide-form-row">
        ...
        <div class="search-group">
            <div class="dual-label-container">
                <span class="label-fr">Impact Financier</span>
                <span class="label-ar">التأثير المالي</span>
            </div>
    ...
    `;
        ...
        function showDateNotif() {
            ...
            if (!cb || !tb) return;
            tb.style.display = cb.checked ? 'inline-block' : 'none';
            if (!cb.checked) tb.value = ''; // optionnel : réinitialiser la date lorsqu'on cache
        }
